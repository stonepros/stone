...
The Stone open source community is guided by a few different groups.

Project Leader
--------------

The Stone project is currently led by Sage Weil <sage@redhat.com>.  The
...
Stone code repositories, currently hosted on GitHub.  This group of developers
is collectively empowered to make changes to the Stone source code.
...
the project) at the discretion of the Stone Leadership Team (below).
...
Stone Leadership Team
--------------------

The Stone Leadership Team (CLT) is a collection of component leads and
...
`https://pad.stone.com/p/clt-weekly-minutes <https://pad.stone.com/p/clt-weekly-minutes>`_.
...
Each major subcomponent of the Stone project has a lead engineer who is
...
Foundation and is tasked with supporting the Stone project community
and ecosystem.  It has no direct control over the technical direction
of the Stone open source project beyond offering feedback and input
