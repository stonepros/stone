...
Stoneadm can also be used directly without compiled ceph binaries.
...
main advantages:
----------------
  - Is fast. Typically you can have a completely new Stone cluster ready to debug
...
install Stone clusters using Stone ansible or cephadm, lets create our first Stone
...
Create a Stone cluster to make easy developing in mgr modules (Orchestrators and Dashboard)
------------------------------------------------------------------------------------------
...
same cephadm plan but with a new parameter pointing your Stone source code folder::
...
Stone Dashboard development
--------------------------
Stone dashboard module is not going to be loaded if previously you have not
generated the frontend bundle.

For now, in order load properly the Stone Dashboardmodule and to apply frontend
