...
To configure virtual hosted buckets, you can either set ``rgw_dns_name = cname.domain.com`` in ceph.conf, or add ``cname.domain.com`` to the list of ``hostnames`` in your zonegroup configuration. See `Stone Object Gateway - Multisite Configuration`_ for more on zonegroups.
...
.. _`Stone Object Gateway - Multisite Configuration`: ../../multisite
