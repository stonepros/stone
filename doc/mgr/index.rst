.. _stone-manager-daemon:

===================
Stone Manager Daemon
===================

The :term:`Stone Manager` daemon (stone-mgr) runs alongside monitor daemons,
to provide additional monitoring and interfaces to external monitoring
and management systems.

Since the 12.x (*luminous*) Stone release, the stone-mgr daemon is required for
normal operations.  The stone-mgr daemon is an optional component in
the 11.x (*kraken*) Stone release.
...
in the output of `stone status` will be missing or stale until a mgr is started.

Use your normal deployment tools, such as stone-ansible or stoneadm, to
set up stone-mgr daemons on each of your mon nodes.  It is not mandatory
...
.. toctree::
    ...
    Stone RESTful API <stone_api/index>
