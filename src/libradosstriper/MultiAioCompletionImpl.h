...
#ifndef STONE_LIBRADOSSTRIPERSTRIPER_MULTIAIOCOMPLETIONIMPL_H
#define STONE_LIBRADOSSTRIPERSTRIPER_MULTIAIOCOMPLETIONIMPL_H
...
#endif // STONE_LIBRADOSSTRIPERSTRIPER_MULTIAIOCOMPLETIONIMPL_H
