...
#define STONE_DOKAN_IO_DEFAULT_TIMEOUT 60 * 5 // Seconds
#define STONE_DOKAN_DEFAULT_THREAD_COUNT 10
...
struct Config {
  ...
  int operation_timeout = STONE_DOKAN_IO_DEFAULT_TIMEOUT;
  int thread_count = STONE_DOKAN_DEFAULT_THREAD_COUNT;
