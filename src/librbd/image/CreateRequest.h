...
#ifndef STONE_LIBRBD_IMAGE_CREATE_REQUEST_H
#define STONE_LIBRBD_IMAGE_CREATE_REQUEST_H
...
public:
  ...
  static int validate_order(StoneContext *cct, uint8_t order);
...
#endif // STONE_LIBRBD_IMAGE_CREATE_REQUEST_H
