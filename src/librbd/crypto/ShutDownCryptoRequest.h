...
#ifndef STONE_LIBRBD_CRYPTO_SHUT_DOWN_CRYPTO_REQUEST_H
#define STONE_LIBRBD_CRYPTO_SHUT_DOWN_CRYPTO_REQUEST_H
...
#endif // STONE_LIBRBD_CRYPTO_SHUT_DOWN_CRYPTO_REQUEST_H
