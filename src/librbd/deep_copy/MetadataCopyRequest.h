...
#ifndef STONE_LIBRBD_DEEP_COPY_METADATA_COPY_REQUEST_H
#define STONE_LIBRBD_DEEP_COPY_METADATA_COPY_REQUEST_H
...
#endif // STONE_LIBRBD_DEEP_COPY_METADATA_COPY_REQUEST_H
