...
#ifndef STONE_LIBRBD_DEEP_COPY_SNAPSHOT_COPY_REQUEST_H
#define STONE_LIBRBD_DEEP_COPY_SNAPSHOT_COPY_REQUEST_H
...
private:
  ...
  librados::snap_t m_prev_snap_id = STONE_NOSNAP;
  ...
  Context *start_lock_op(stone::shared_mutex &owner_locki, int* r);
...
#endif // STONE_LIBRBD_DEEP_COPY_SNAPSHOT_COPY_REQUEST_H
