...
#ifndef STONE_LIBRBD_IMAGE_WATCHER_NOTIFY_LOCK_OWNER_H
#define STONE_LIBRBD_IMAGE_WATCHER_NOTIFY_LOCK_OWNER_H
...
#endif // STONE_LIBRBD_IMAGE_WATCHER_NOTIFY_LOCK_OWNER_H
