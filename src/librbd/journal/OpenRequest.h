...
#ifndef STONE_LIBRBD_JOURNAL_OPEN_REQUEST_H
#define STONE_LIBRBD_JOURNAL_OPEN_REQUEST_H
...
public:
  ...
  OpenRequest(ImageCtxT *image_ctx, Journaler *journaler, stone::mutex *lock,
...
#endif // STONE_LIBRBD_JOURNAL_OPEN_REQUEST_H
