...
#ifndef STONE_LIBRBD_OPERATION_SNAPSHOT_LIMIT_REQUEST_H
#define STONE_LIBRBD_OPERATION_SNAPSHOT_LIMIT_REQUEST_H
...
#endif // STONE_LIBRBD_OPERATION_SNAPSHOT_LIMIT_REQUEST_H
