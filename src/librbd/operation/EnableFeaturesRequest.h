...
#ifndef STONE_LIBRBD_OPERATION_ENABLE_FEATURES_REQUEST_H
#define STONE_LIBRBD_OPERATION_ENABLE_FEATURES_REQUEST_H
...
#endif // STONE_LIBRBD_OPERATION_ENABLE_FEATURES_REQUEST_H
