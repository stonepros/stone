...
#ifndef STONE_LIBRBD_OPERATION_METADATA_REMOVE_REQUEST_H
#define STONE_LIBRBD_OPERATION_METADATA_REMOVE_REQUEST_H
...
#endif // STONE_LIBRBD_OPERATION_METADATA_REMOVE_REQUEST_H
