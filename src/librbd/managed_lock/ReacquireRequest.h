...
#ifndef STONE_LIBRBD_MANAGED_LOCK_REACQUIRE_REQUEST_H
#define STONE_LIBRBD_MANAGED_LOCK_REACQUIRE_REQUEST_H
...
#endif // STONE_LIBRBD_MANAGED_LOCK_REACQUIRE_REQUEST_H
