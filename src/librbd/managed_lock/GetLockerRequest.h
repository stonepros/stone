...
#ifndef STONE_LIBRBD_MANAGED_LOCK_GET_LOCKER_REQUEST_H
#define STONE_LIBRBD_MANAGED_LOCK_GET_LOCKER_REQUEST_H
...
#endif // STONE_LIBRBD_MANAGED_LOCK_GET_LOCKER_REQUEST_H
