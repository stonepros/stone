...
#ifndef STONE_LIBRBD_OBJECT_MAP_SNAPSHOT_CREATE_REQUEST_H
#define STONE_LIBRBD_OBJECT_MAP_SNAPSHOT_CREATE_REQUEST_H
...
#endif // STONE_LIBRBD_OBJECT_MAP_SNAPSHOT_CREATE_REQUEST_H
