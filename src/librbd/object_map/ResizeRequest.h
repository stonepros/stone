...
#ifndef STONE_LIBRBD_OBJECT_MAP_RESIZE_REQUEST_H
#define STONE_LIBRBD_OBJECT_MAP_RESIZE_REQUEST_H
...
public:
  ResizeRequest(ImageCtx &image_ctx, stone::shared_mutex *object_map_lock,
  ...
  static void resize(stone::BitVector<2> *object_map, uint64_t num_objs,
...
#endif // STONE_LIBRBD_OBJECT_MAP_RESIZE_REQUEST_H
