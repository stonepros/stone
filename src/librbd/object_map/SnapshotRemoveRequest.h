...
#ifndef STONE_LIBRBD_OBJECT_MAP_SNAPSHOT_REMOVE_REQUEST_H
#define STONE_LIBRBD_OBJECT_MAP_SNAPSHOT_REMOVE_REQUEST_H
...
public:
  ...
  SnapshotRemoveRequest(ImageCtx &image_ctx, stone::shared_mutex* object_map_lock,
    ...
    : AsyncRequest(image_ctx, on_finish),
      ...
      m_snap_id(snap_id), m_next_snap_id(STONE_NOSNAP) {
  }
...
private:
  ...
  stone::BitVector<2> m_snap_object_map;
  bufferlist m_out_bl;
...
#endif // STONE_LIBRBD_OBJECT_MAP_SNAPSHOT_REMOVE_REQUEST_H
