...
#ifndef STONE_LIBRBD_MIGRATION_HTTP_PROCESSOR_INTERFACE_H
#define STONE_LIBRBD_MIGRATION_HTTP_PROCESSOR_INTERFACE_H
...
#endif // STONE_LIBRBD_MIGRATION_HTTP_PROCESSOR_INTERFACE_H
