...
#ifndef STONE_LIBRBD_MIGRATION_SOURCE_SPEC_BUILDER_H
#define STONE_LIBRBD_MIGRATION_SOURCE_SPEC_BUILDER_H
...
#endif // STONE_LIBRBD_MIGRATION_SOURCE_SPEC_BUILDER_H
