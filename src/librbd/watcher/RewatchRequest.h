...
#ifndef STONE_LIBRBD_WATCHER_REWATCH_REQUEST_H
#define STONE_LIBRBD_WATCHER_REWATCH_REQUEST_H
...
private:
  ...
  std::string m_oid;
  stone::shared_mutex &m_watch_lock;
...
#endif // STONE_LIBRBD_WATCHER_REWATCH_REQUEST_H
