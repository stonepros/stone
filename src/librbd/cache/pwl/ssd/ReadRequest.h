...
#ifndef STONE_LIBRBD_CACHE_PWL_SSD_READ_REQUEST_H
#define STONE_LIBRBD_CACHE_PWL_SSD_READ_REQUEST_H
...
public:
  C_ReadRequest(StoneContext *cct, utime_t arrived, PerfCounters *perfcounter, bufferlist *out_bl, Context *on_finish)
...
#endif // STONE_LIBRBD_CACHE_PWL_SSD_READ_REQUEST_H
