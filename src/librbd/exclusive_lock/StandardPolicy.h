...
#ifndef STONE_LIBRBD_EXCLUSIVE_LOCK_STANDARD_POLICY_H
#define STONE_LIBRBD_EXCLUSIVE_LOCK_STANDARD_POLICY_H
...
#endif // STONE_LIBRBD_EXCLUSIVE_LOCK_STANDARD_POLICY_H
