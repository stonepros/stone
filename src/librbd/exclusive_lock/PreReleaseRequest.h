...
#ifndef STONE_LIBRBD_EXCLUSIVE_LOCK_PRE_RELEASE_REQUEST_H
#define STONE_LIBRBD_EXCLUSIVE_LOCK_PRE_RELEASE_REQUEST_H
...
#endif // STONE_LIBRBD_EXCLUSIVE_LOCK_PRE_RELEASE_REQUEST_H
