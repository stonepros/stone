...
#ifndef STONE_LIBRBD_EXCLUSIVE_LOCK_PRE_ACQUIRE_REQUEST_H
#define STONE_LIBRBD_EXCLUSIVE_LOCK_PRE_ACQUIRE_REQUEST_H
...
#endif // STONE_LIBRBD_EXCLUSIVE_LOCK_ACQUIRE_REQUEST_H
