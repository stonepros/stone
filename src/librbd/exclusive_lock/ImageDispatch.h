...
#ifndef STONE_LIBRBD_EXCLUSIVE_LOCK_IMAGE_DISPATCH_H
#define STONE_LIBRBD_EXCLUSIVE_LOCK_IMAGE_DISPATCH_H
...
#endif // STONE_LIBRBD_EXCLUSIVE_LOCK_IMAGE_DISPATCH_H
