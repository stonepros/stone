...
#ifndef STONE_LIBRBD_IO_WRITE_BLOCK_IMAGE_DISPATCH_H
#define STONE_LIBRBD_IO_WRITE_BLOCK_IMAGE_DISPATCH_H
...
#endif // STONE_LIBRBD_IO_WRITE_BLOCK_IMAGE_DISPATCH_H
