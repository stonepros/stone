...
#ifndef STONE_LIBRBD_IO_OBJECT_DISPATCHER_INTERFACE_H
#define STONE_LIBRBD_IO_OBJECT_DISPATCHER_INTERFACE_H
...
#endif // STONE_LIBRBD_IO_OBJECT_DISPATCHER_INTERFACE_H
