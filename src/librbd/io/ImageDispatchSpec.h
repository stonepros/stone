...
#ifndef STONE_LIBRBD_IO_IMAGE_DISPATCH_SPEC_H
#define STONE_LIBRBD_IO_IMAGE_DISPATCH_SPEC_H
...
private:
  ...
  ImageDispatchSpec(ImageDispatcherInterface* image_dispatcher,
    ...
    stone_assert(aio_comp->image_dispatcher_ctx == nullptr);
...
#endif // STONE_LIBRBD_IO_IMAGE_DISPATCH_SPEC_H
