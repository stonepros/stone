...
struct RefreshRequest<MockTestImageCtx> {
  ...
  stone::BitVector<2u> *object_map = nullptr;
  static RefreshRequest *s_instance;
  static RefreshRequest *create(MockTestImageCtx &image_ctx, stone::shared_mutex*,
                                stone::BitVector<2u> *object_map,
...
struct UpdateRequest<MockTestImageCtx> {
  ...
  static UpdateRequest *create(MockTestImageCtx &image_ctx, stone::shared_mutex*,
                               stone::BitVector<2u> *object_map,
                               uint64_t snap_id,
...
public:
  ...
  void expect_refresh(MockTestImageCtx &mock_image_ctx,
                      ...
                      const stone::BitVector<2u> &object_map, int r) {
...
TEST_F(TestMockObjectMap, NonDetainedUpdate) {
  ...
  expect_update(mock_image_ctx, mock_update_request, STONE_NOSNAP,
  ...
  MockObjectMap *mock_object_map = new MockObjectMap(mock_image_ctx, STONE_NOSNAP);
  ...
  C_SaferCond update_ctx2;
  {
    ...
    mock_object_map->aio_update(STONE_NOSNAP, 0, 1, {}, {}, false, &update_ctx1);
    mock_object_map->aio_update(STONE_NOSNAP, 1, 1, {}, {}, false, &update_ctx2);
  }
...
TEST_F(TestMockObjectMap, DetainedUpdate) {
  ...
  {
    std::shared_lock image_locker{mock_image_ctx.image_lock};
    mock_object_map->aio_update(STONE_NOSNAP, 1, 4, 1, {}, {}, false,
                               &update_ctx1);
    mock_object_map->aio_update(STONE_NOSNAP, 1, 3, 1, {}, {}, false,
                               &update_ctx2);
    mock_object_map->aio_update(STONE_NOSNAP, 2, 3, 1, {}, {}, false,
                               &update_ctx3);
    mock_object_map->aio_update(STONE_NOSNAP, 0, 2, 1, {}, {}, false,
                               &update_ctx4);
  }
