...
Delete the host
===============
  $ sudo gwcli iscsi-targets/iqn.2003-01.com.redhat.iscsi-gw:stone-gw/hosts delete client_iqn=iqn.1994-05.com.redhat:client
  $ sudo gwcli ls iscsi-targets/ | grep 'o- hosts' | awk -F'[' '{print $2}'
  Auth: ACL_ENABLED, Hosts: 0]

Delete the iscsi-targets disk
=============================
  $ sudo gwcli iscsi-targets/iqn.2003-01.com.redhat.iscsi-gw:stone-gw/disks/ delete disk=datapool/block0
  $ sudo gwcli ls iscsi-targets/ | grep 'o- disks' | awk -F'[' '{print $2}'
  Disks: 0]

Delete the target IQN
=====================
  $ sudo gwcli iscsi-targets/ delete target_iqn=iqn.2003-01.com.redhat.iscsi-gw:stone-gw
