...
{
  char arr[65] = {};
  ASSERT_EQ(0, gen_rand_base64(g_stone_context, arr, sizeof(arr)));
...
{
  char arr[65] = {};
  gen_rand_alphanumeric(g_stone_context, arr, sizeof(arr));
  EXPECT_EQ(0, arr[64]);
...
{
  std::string str = gen_rand_alphanumeric(g_stone_context, 64);
...
{
  char arr[65] = {};
  gen_rand_alphanumeric_lower(g_stone_context, arr, sizeof(arr));
  EXPECT_EQ(0, arr[64]);
...
{
  std::string str = gen_rand_alphanumeric_lower(g_stone_context, 64);
  EXPECT_EQ(64, str.size());
...
{
  char arr[65] = {};
  gen_rand_alphanumeric_upper(g_stone_context, arr, sizeof(arr));
  EXPECT_EQ(0, arr[64]);
...
{
  std::string str = gen_rand_alphanumeric_upper(g_stone_context, 64);
  EXPECT_EQ(64, str.size());
...
{
  char arr[65] = {};
  gen_rand_alphanumeric_no_underscore(g_stone_context, arr, sizeof(arr));
  EXPECT_EQ(0, arr[64]);
...
{
  std::string str = gen_rand_alphanumeric_no_underscore(g_stone_context, 64);
  EXPECT_EQ(64, str.size());
...
{
  char arr[65] = {};
  gen_rand_alphanumeric_plain(g_stone_context, arr, sizeof(arr));
  EXPECT_EQ(0, arr[64]);
...
{
  std::string str = gen_rand_alphanumeric_plain(g_stone_context, 64);
  EXPECT_EQ(64, str.size());
