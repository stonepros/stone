...
#ifndef STONE_CRYPTO_H
#define STONE_CRYPTO_H
...
#define STONE_CRYPTO_MD5_DIGESTSIZE 16
#define STONE_CRYPTO_HMACSHA1_DIGESTSIZE 20
#define STONE_CRYPTO_SHA1_DIGESTSIZE 20
#define STONE_CRYPTO_HMACSHA256_DIGESTSIZE 32
#define STONE_CRYPTO_SHA256_DIGESTSIZE 32
#define STONE_CRYPTO_SHA512_DIGESTSIZE 64
...
namespace TOPNSPC::crypto {
  ...
  namespace ssl {
    ...
    class MD5 : public OpenSSLDigest {
      public:
	static constexpr size_t digest_size = STONE_CRYPTO_MD5_DIGESTSIZE;
	MD5 () : OpenSSLDigest(EVP_md5()) { }
    };

    class SHA1 : public OpenSSLDigest {
      public:
        static constexpr size_t digest_size = STONE_CRYPTO_SHA1_DIGESTSIZE;
        SHA1 () : OpenSSLDigest(EVP_sha1()) { }
    };

    class SHA256 : public OpenSSLDigest {
      public:
        static constexpr size_t digest_size = STONE_CRYPTO_SHA256_DIGESTSIZE;
        SHA256 () : OpenSSLDigest(EVP_sha256()) { }
    };

    class SHA512 : public OpenSSLDigest {
      public:
        static constexpr size_t digest_size = STONE_CRYPTO_SHA512_DIGESTSIZE;
