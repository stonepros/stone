...
#ifndef STONE_SCRUB_TYPES_H
#define STONE_SCRUB_TYPES_H
...
namespace librados {
inline void decode(object_id_t& obj, stone::buffer::list::const_iterator& bp) {
...
namespace librados {
  inline void decode(librados::osd_shard_t& shard, stone::buffer::list::const_iterator& bp) {
...
namespace librados {
  inline void decode(librados::shard_info_t& shard,
		     stone::buffer::list::const_iterator& bp) {
...
struct scrub_ls_result_t {
  epoch_t interval;
  std::vector<stone::buffer::list> vals;
  void encode(stone::buffer::list& bl) const;
  void decode(stone::buffer::list::const_iterator& bl);
};
