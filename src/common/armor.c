...
int stone_armor_line_break(char *dst, const char *dst_end, const char *src, const char *end, int line_width)
{
	int olen = 0;
	int line = 0;
...
int stone_armor(char *dst, const char *dst_end, const char *src, const char *end)
{
	return stone_armor_line_break(dst, dst_end, src, end, 0);
}

int stone_unarmor(char *dst, const char *dst_end, const char *src, const char *end)
{
	int olen = 0;
