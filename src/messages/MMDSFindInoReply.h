...
#ifndef STONE_MDSFINDINOREPLY_H
#define STONE_MDSFINDINOREPLY_H
...
protected:
  ...
  MMDSFindInoReply(stone_tid_t t) : MMDSOp{MSG_MDS_FINDINOREPLY, HEAD_VERSION, COMPAT_VERSION}, tid(t) {}
