...
#ifndef STONE_RBD_MIRROR_IMAGE_MAP_STATE_TRANSITION_H
#define STONE_RBD_MIRROR_IMAGE_MAP_STATE_TRANSITION_H
...
#endif // STONE_RBD_MIRROR_IMAGE_MAP_STATE_TRANSITION_H
