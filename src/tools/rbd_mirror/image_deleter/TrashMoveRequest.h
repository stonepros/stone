...
#ifndef STONE_RBD_MIRROR_IMAGE_DELETE_TRASH_MOVE_REQUEST_H
#define STONE_RBD_MIRROR_IMAGE_DELETE_TRASH_MOVE_REQUEST_H
...
#endif // STONE_RBD_MIRROR_IMAGE_DELETE_TRASH_WATCHER_H
