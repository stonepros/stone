...
int Resetter::reset()
{
  stone::mutex mylock = stone::make_mutex("Resetter::reset::lock");
...
int Resetter::_write_reset_event(Journaler *journaler)
{
  ...
  bufferlist bl;
  le->encode_with_header(bl, STONE_FEATURES_SUPPORTED_DEFAULT);
