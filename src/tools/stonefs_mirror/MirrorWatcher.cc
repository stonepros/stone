...
#undef dout_prefix
#define dout_prefix *_dout << "stonefs::mirror::MirrorWatcher " << __func__
...
MirrorWatcher::MirrorWatcher(librados::IoCtx &ioctx, FSMirror *fs_mirror,
  ...
  : Watcher(ioctx, STONEFS_MIRROR_OBJECT, work_queue),
    m_ioctx(ioctx),
    m_fs_mirror(fs_mirror),
    m_work_queue(work_queue),
    m_lock(stone::make_mutex("stonefs::mirror::mirror_watcher")),
