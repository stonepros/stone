...
class ErasureCodeClay final : public stone::ErasureCode {
public:
  ...
  std::map<int, stone::bufferlist> U_buf;
  ...
  int decode(const std::set<int> &want_to_read,
             const std::map<int, stone::bufferlist> &chunks,
             std::map<int, stone::bufferlist> *decoded, int chunk_size) override;

  int encode_chunks(const std::set<int> &want_to_encode,
	            std::map<int, stone::bufferlist> *encoded) override;

  int decode_chunks(const std::set<int> &want_to_read,
		    const std::map<int, stone::bufferlist> &chunks,
		    std::map<int, stone::bufferlist> *decoded) override;
...
private:
  ...
  int repair(const std::set<int> &want_to_read,
             const std::map<int, stone::bufferlist> &chunks,
             std::map<int, stone::bufferlist> *recovered, int chunk_size);

  int decode_layered(std::set<int>& erased_chunks, std::map<int, stone::bufferlist>* chunks);

  int repair_one_lost_chunk(std::map<int, stone::bufferlist> &recovered_data, std::set<int> &aloof_nodes,
                            std::map<int, stone::bufferlist> &helper_data, int repair_blocksize,
  ...
  int decode_erasures(const std::set<int>& erased_chunks, int z,
                      std::map<int, stone::bufferlist>* chunks, int sc_size);
  ...
  void recover_type1_erasure(std::map<int, stone::bufferlist>* chunks, int x, int y, int z,
                             int* z_vec, int sc_size);

  void get_uncoupled_from_coupled(std::map<int, stone::bufferlist>* chunks, int x, int y, int z,
                                  int* z_vec, int sc_size);

  void get_coupled_from_uncoupled(std::map<int, stone::bufferlist>* chunks, int x, int y, int z,
                                  int* z_vec, int sc_size);
