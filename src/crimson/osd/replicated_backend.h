...
private:
  ll_read_errorator::future<stone::bufferlist> _read(const hobject_t& hoid,
					            uint64_t off,
					            uint64_t len,
  ...
  using pending_transactions_t = std::map<stone_tid_t, pending_on_t>;
