...
setup(
    ...
    long_description=(
        ...
        "that uses a Stone Storage Cluster to store its data. The "
        "Stone Object Storage support S3 and Swift APIs, "
        "and file operations."
    ),
    url='https://github.com/stone/stone/tree/master/src/pybind/rgw',
    license='LGPLv2+',
    platforms='Linux',
