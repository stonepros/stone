...
@Component({
  selector: 'cd-stonefs-tabs',
  templateUrl: './stonefs-tabs.component.html',
  styleUrls: ['./stonefs-tabs.component.scss']
})
export class StonefsTabsComponent implements OnChanges, OnDestroy {
  @Input()
  selection: any;
  ...
  refresh() {
    this.stonefsService.getTabs(this.id).subscribe(
      (data: any) => {
        this.data = data;
        this.softRefresh();
      },
