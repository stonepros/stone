...
@Component({
  selector: 'cd-stonefs-detail',
  templateUrl: './stonefs-detail.component.html',
  styleUrls: ['./stonefs-detail.component.scss']
})
export class StonefsDetailComponent implements OnChanges, OnInit {
