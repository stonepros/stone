...
import { StonefsTabsComponent } from './stonefs-tabs.component';

describe('StonefsTabsComponent', () => {
  let component: StonefsTabsComponent;
  let fixture: ComponentFixture<StonefsTabsComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(StonefsTabsComponent);
