...
@Component({
  selector: 'cd-stonefs-clients',
  templateUrl: './stonefs-clients.component.html',
  styleUrls: ['./stonefs-clients.component.scss']
})
export class StonefsClientsComponent implements OnInit {
  @Input()
  id: number;
  ...
  evictClient(clientId: number) {
    this.stonefsService.evictClient(this.id, clientId).subscribe(
      () => {
