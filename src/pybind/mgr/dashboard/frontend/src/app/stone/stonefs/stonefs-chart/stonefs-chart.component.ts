...
@Component({
  selector: 'cd-stonefs-chart',
  templateUrl: './stonefs-chart.component.html',
  styleUrls: ['./stonefs-chart.component.scss']
})
export class StonefsChartComponent implements OnChanges, OnInit {
  ...
  /**
   * Convert stone-mgr's time series format (list of 2-tuples
