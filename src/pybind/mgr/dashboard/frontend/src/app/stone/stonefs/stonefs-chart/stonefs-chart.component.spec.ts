...
import { StonefsChartComponent } from './stonefs-chart.component';

describe('StonefsChartComponent', () => {
  let component: StonefsChartComponent;
  let fixture: ComponentFixture<StonefsChartComponent>;
  ...
  configureTestBed({
    ...
    declarations: [StonefsChartComponent]
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(StonefsChartComponent);
