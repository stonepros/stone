...
class Context;
namespace stone { template <uint8_t> class BitVector; }
...
int get_features_finish(stone::buffer::list::const_iterator *it, uint64_t *features,
...
int get_object_prefix_finish(stone::buffer::list::const_iterator *it,
...
int get_data_pool_finish(stone::buffer::list::const_iterator *it, int64_t *data_pool_id);
...
int get_size_finish(stone::buffer::list::const_iterator *it, uint64_t *size,
                    uint8_t *order);
...
int get_flags_finish(stone::buffer::list::const_iterator *it, uint64_t *flags);
...
int op_features_get_finish(stone::buffer::list::const_iterator *it,
...
int get_parent_finish(stone::buffer::list::const_iterator *it,
...
int parent_get_finish(stone::buffer::list::const_iterator* it,
...
void parent_overlap_get_start(librados::ObjectReadOperation* op,
                              snapid_t snap_id);
int parent_overlap_get_finish(stone::buffer::list::const_iterator* it,
...
void get_children_start(librados::ObjectReadOperation *op,
                        const cls::rbd::ParentImageSpec &pspec);
int get_children_finish(stone::buffer::list::const_iterator *it,
...
void snapshot_get_start(librados::ObjectReadOperation* op,
                        snapid_t snap_id);
int snapshot_get_finish(stone::buffer::list::const_iterator* it,
...
int get_snapcontext_finish(stone::buffer::list::const_iterator *it,
                           ::SnapContext *snapc);
...
void get_snapshot_name_start(librados::ObjectReadOperation *op,
                             snapid_t snap_id);
int get_snapshot_name_finish(stone::buffer::list::const_iterator *it,
                             std::string *name);
...
void get_snapshot_timestamp_start(librados::ObjectReadOperation *op,
                                  snapid_t snap_id);
int get_snapshot_timestamp_finish(stone::buffer::list::const_iterator *it,
                                  utime_t *timestamp);
...
int get_all_features_finish(stone::buffer::list::const_iterator *it,
...
void get_protection_status_start(librados::ObjectReadOperation *op,
                                 snapid_t snap_id);
int get_protection_status_finish(stone::buffer::list::const_iterator *it,
...
int snapshot_get_limit_finish(stone::buffer::list::const_iterator *it, uint64_t *limit);
...
int get_stripe_unit_count_finish(stone::buffer::list::const_iterator *it,
...
int get_create_timestamp_finish(stone::buffer::list::const_iterator *it,
                                utime_t *timestamp);
...
int get_access_timestamp_finish(stone::buffer::list::const_iterator *it,
                                utime_t *timestamp);
...
int get_modify_timestamp_finish(stone::buffer::list::const_iterator *it,
                                utime_t *timestamp);
...
int metadata_list(librados::IoCtx *ioctx, const std::string &oid,
                  ...
                  std::map<std::string, stone::buffer::list> *pairs);
void metadata_list_start(librados::ObjectReadOperation *op,
                         const std::string &start, uint64_t max_return);
int metadata_list_finish(stone::buffer::list::const_iterator *it,
                         std::map<std::string, stone::buffer::list> *pairs);
void metadata_set(librados::ObjectWriteOperation *op,
                  const std::map<std::string, stone::buffer::list> &data);
...
void metadata_get_start(librados::ObjectReadOperation* op,
                 const std::string &key);
int metadata_get_finish(stone::buffer::list::const_iterator *it,
                        std::string* value);
...
void children_list_start(librados::ObjectReadOperation *op,
                         snapid_t snap_id);
int children_list_finish(stone::buffer::list::const_iterator *it,
...
int migration_get_finish(stone::buffer::list::const_iterator *it,
...
int get_id_finish(stone::buffer::list::const_iterator *it, std::string *id);
...
int dir_get_id_finish(stone::buffer::list::const_iterator *iter, std::string *image_id);
void dir_get_name_start(librados::ObjectReadOperation *op,
                        const std::string &id);
int dir_get_name_finish(stone::buffer::list::const_iterator *it, std::string *name);
...
void dir_list_start(librados::ObjectReadOperation *op,
                    const std::string &start, uint64_t max_return);
int dir_list_finish(stone::buffer::list::const_iterator *it, std::map<std::string, std::string> *images);
...
int object_map_load_finish(stone::buffer::list::const_iterator *it,
...
int old_snapshot_list_finish(stone::buffer::list::const_iterator *it,
...
int mirror_uuid_get_finish(stone::buffer::list::const_iterator *it,
                           std::string *uuid);
...
int mirror_mode_get_finish(stone::buffer::list::const_iterator *it,
...
int mirror_peer_list_finish(stone::buffer::list::const_iterator *it,
...
void mirror_image_list_start(librados::ObjectReadOperation *op,
                             const std::string &start, uint64_t max_return);
int mirror_image_list_finish(stone::buffer::list::const_iterator *it,
...
int mirror_image_get_image_id_finish(stone::buffer::list::const_iterator *it,
                                     std::string *image_id);
...
int mirror_image_get_finish(stone::buffer::list::const_iterator *iter,
                            cls::rbd::MirrorImage *mirror_image);
...
void mirror_image_status_get_start(librados::ObjectReadOperation *op,
                                   const std::string &global_image_id);
int mirror_image_status_get_finish(stone::buffer::list::const_iterator *iter,
                                   cls::rbd::MirrorImageStatus *status);
...
void mirror_image_status_list_start(librados::ObjectReadOperation *op,
                                    ...
                                    uint64_t max_return);
int mirror_image_status_list_finish(stone::buffer::list::const_iterator *iter,
                                    std::map<std::string, cls::rbd::MirrorImage> *images,
                                    std::map<std::string, cls::rbd::MirrorImageStatus> *statuses);
...
void mirror_image_instance_get_start(librados::ObjectReadOperation *op,
                                     const std::string &global_image_id);
int mirror_image_instance_get_finish(stone::buffer::list::const_iterator *iter,
                                     entity_inst_t *instance);
...
void mirror_image_instance_list_start(librados::ObjectReadOperation *op,
                                      const std::string &start,
                                      uint64_t max_return);
int mirror_image_instance_list_finish(stone::buffer::list::const_iterator *iter,
                                      std::map<std::string, entity_inst_t> *instances);

void mirror_instances_list_start(librados::ObjectReadOperation *op);
int mirror_instances_list_finish(stone::buffer::list::const_iterator *iter,
...
void mirror_image_map_list_start(librados::ObjectReadOperation *op,
                                 ...
                                 uint64_t max_read);
int mirror_image_map_list_finish(stone::buffer::list::const_iterator *iter,
...
int image_group_get_finish(stone::buffer::list::const_iterator *iter,
...
void trash_list_start(librados::ObjectReadOperation *op,
                      const std::string &start, uint64_t max_return);
int trash_list_finish(stone::buffer::list::const_iterator *it,
...
void trash_get_start(librados::ObjectReadOperation *op,
                     const std::string &id);
int trash_get_finish(stone::buffer::list::const_iterator *it,
...
void namespace_list_start(librados::ObjectReadOperation *op,
                          const std::string &start, uint64_t max_return);
int namespace_list_finish(stone::buffer::list::const_iterator *it,
...
void copyup(librados::ObjectWriteOperation *op, stone::buffer::list data);
