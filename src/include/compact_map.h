...
template<class Key, class T, class Map>
inline void encode(const compact_map_base<Key, T, Map>& m, stone::buffer::list& bl) {
  m.encode(bl);
}
template<class Key, class T, class Map>
inline void encode(const compact_map_base<Key, T, Map>& m, stone::buffer::list& bl,
...
template<class Key, class T, class Map>
inline void decode(compact_map_base<Key, T, Map>& m, stone::buffer::list::const_iterator& p) {
  m.decode(p);
}
