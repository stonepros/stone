...
using StoneContext = ceph::common::StoneContext;
extern "C" {
#endif
...
/**
 * Create a mount handle for interacting with Stone.  All libcephfs
 ...
 * for the ceph cluster.  A StoneContext can be acquired from an existing ceph_mount_info
 * handle, using the @ref ceph_get_mount_context call.  Note that using the same StoneContext
 ...
 */
#ifdef __cplusplus
int ceph_create_with_context(struct ceph_mount_info **cmount, StoneContext *conf);
#else
int ceph_create_with_context(struct ceph_mount_info **cmount, struct StoneContext *conf);
#endif
 ...
 */
#ifdef __cplusplus
StoneContext *ceph_get_mount_context(struct ceph_mount_info *cmount);
#else
struct StoneContext *ceph_get_mount_context(struct ceph_mount_info *cmount);
#endif
/*
 * Check mount status.
 *
