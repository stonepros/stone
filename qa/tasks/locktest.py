...
def task(ctx, config):
    ...
    clients. Whether the clients are stone-fuse or kernel does not
        ...
        for client_name in config:
            ...
            ctx.cluster.only(client_name).run(
                args=[
                    ...
                    'wget',
                    '-nv',
                    'https://raw.github.com/gregsfortytwo/xfstests-stone/master/src/locktest.c',
