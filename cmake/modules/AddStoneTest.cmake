#AddStoneTest is a module for adding tests to the "make check" target which runs CTest

#adds makes target/script into a test, test to check target, sets necessary environment variables
function(add_stone_test test_name test_path)
  ...
  set_property(TEST ${test_name}
    ...
    STONE_ROOT=${CMAKE_SOURCE_DIR}
    STONE_BIN=${CMAKE_RUNTIME_OUTPUT_DIRECTORY}
    STONE_LIB=${CMAKE_LIBRARY_OUTPUT_DIRECTORY}
    STONE_BUILD_DIR=${CMAKE_BINARY_DIR}
    LD_LIBRARY_PATH=${CMAKE_BINARY_DIR}/lib
    PATH=${CMAKE_RUNTIME_OUTPUT_DIRECTORY}:${CMAKE_SOURCE_DIR}/src:$ENV{PATH}
    PYTHONPATH=${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/cython_modules/lib.3:${CMAKE_SOURCE_DIR}/src/pybind
    STONE_BUILD_VIRTUALENV=${STONE_BUILD_VIRTUALENV})
  # none of the tests should take more than 1 hour to complete
  set_property(TEST ${test_name}
    PROPERTY TIMEOUT ${STONE_TEST_TIMEOUT})
endfunction()
...
function(add_stone_unittest unittest_name)
  ...
  add_stone_test(${unittest_name} "${UNITTEST}" ${UT_UNPARSED_ARGUMENTS})
  target_link_libraries(${unittest_name} ${UNITTEST_LIBS})
endfunction()

function(add_tox_test name)
  set(test_name run-tox-${name})
  set(venv_path ${STONE_BUILD_VIRTUALENV}/${name}-virtualenv)
